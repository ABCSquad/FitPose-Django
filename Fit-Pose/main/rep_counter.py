...
def lateral_reps(right_deviation, left_deviation, right_shoulder_angle, left_shoulder_angle, reps):
    ...
    if right_deviation < 15 and left_deviation < 15:
        ...
        if right_shoulder_angle < 20 and left_shoulder_angle < 20 and reps['flag'] == 0:
            reps['flag'] = 1
            reps['count'] += 1
            reps['time'][reps['count']] = time.time()

        elif right_shoulder_angle > 90 and left_shoulder_angle > 90 and (reps['flag'] == 1 or reps['flag'] == -1):
            reps['flag'] = 0
